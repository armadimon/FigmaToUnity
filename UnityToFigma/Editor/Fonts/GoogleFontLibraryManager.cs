...
namespace UnityToFigma.Editor.Fonts
{
    ...
    public static class GoogleFontLibraryManager
    {
        ...
        /// <returns></returns>
        public static string PathToTtfFont(string fontName, int fontWeight, FigmaImportPathResolver paths)
        {
            return $"{paths.FontsDirectory}/{CombinedFontName(fontName,fontWeight)}.ttf";
        }
        ...
        /// <param name="fontWeight"></param>
        /// <returns></returns>
        public static string PathToTmpFont(string fontName, int fontWeight, FigmaImportPathResolver paths)
        {
            return $"{paths.FontsDirectory}/{CombinedFontName(fontName,fontWeight)}_SDF.asset";
        }
        ...
        /// <param name="fontWeight"></param>
        /// <returns></returns>
        public static bool CheckFontExistsLocally(string fontName, int fontWeight, FigmaImportPathResolver paths)
        {
            return File.Exists(PathToTmpFont(fontName, fontWeight, paths));
        }


        public static TMP_FontAsset GetFontAsset(string fontName, int fontWeight, FigmaImportPathResolver paths)
        {
            return AssetDatabase.LoadAssetAtPath<TMP_FontAsset>(PathToTmpFont(fontName, fontWeight, paths));
        }
        ...
        public static async Task<bool> ImportFont(string fontName, int fontWeight, FigmaImportPathResolver paths)
        {
            ...
            var fontFilePath = PathToTtfFont(fontName, fontWeight, paths);
            ...
            var tmpFilePath = PathToTmpFont(fontName, fontWeight, paths);
