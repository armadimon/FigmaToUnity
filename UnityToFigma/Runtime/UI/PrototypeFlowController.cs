...
namespace UnityToFigma.Runtime.UI
{
    ...
    public class PrototypeFlowController : MonoBehaviour
    {
        ...
        /// <summary>
        /// The content holder rect transform. During Editor import with prototype flow, this is resolved
        /// or created as a child of this controller using the configured screen parent object name in
        /// UnityToFigma settings.
        /// </summary>
