...
//
// 배경: UI Image 의 sprite 가 null 인 채로 만들면 Unity 의 기본 UISprite (둥근 모서리)
// 로 렌더링된다. 각진 사각형을 원하면 프로젝트의 평면 화이트 스프라이트로 일괄
// 교체하는 게 가장 빠르다.
//
...
//       r.Log("Replace UI Images With Flat Sprite: {0}", ok);
//     }
//   }
//
